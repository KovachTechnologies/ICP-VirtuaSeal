...
import { idlFactory } from './NonDisclosureAgreement_backend.did.js';
export { idlFactory } from './NonDisclosureAgreement_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NONDISCLOSUREAGREEMENT_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./NonDisclosureAgreement_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the NonDisclosureAgreement_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./NonDisclosureAgreement_backend.did.js")._SERVICE>}
 */
export const NonDisclosureAgreement_backend = createActor(canisterId);
