...
import { idlFactory } from './NonDisclosureAgreement_frontend.did.js';
export { idlFactory } from './NonDisclosureAgreement_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NONDISCLOSUREAGREEMENT_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./NonDisclosureAgreement_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the NonDisclosureAgreement_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./NonDisclosureAgreement_frontend.did.js")._SERVICE>}
 */
export const NonDisclosureAgreement_frontend = createActor(canisterId);
