...
// 2023-11-03 https://m7sm4-2iaaa-aaaab-qabra-cai.ic0.app/?tag=4114350440 - document ts + title
...
actor {
  ...
  public shared ({ caller }) func get_signatures(index : Text) : async [s__] {
    let filtered_templates = Trie.filter(signature_trie_, func(_ : Text, s : s__) : Bool = s.document_id_ == index);
