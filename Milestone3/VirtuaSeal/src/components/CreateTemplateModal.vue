...
const templateIsPrivate = ref(true);

const isOpen: Ref<boolean> = ref(false);
const closeModal: () => boolean = () => (isOpen.value = false);
const openModal: () => boolean = () => (isOpen.value = true);
...
<template>
    <div>
        <u-btn :variant="btnVariant" :color="btnColor" :prepend-icon="btnIcon" @click="openModal()">
            Create Template
        </u-btn>
