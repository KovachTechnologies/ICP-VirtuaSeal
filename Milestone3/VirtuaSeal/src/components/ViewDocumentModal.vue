...
<template>
    <div>
        <u-btn prepend-icon="eye" block @click="openModal()">View document</u-btn>
                ...
                `"
                            >
                                <DialogTitle as="h3" class="text-lg font-semibold leading-7 text-primary">
                                    Document {{ documentStore.currentDocument?.title }}
                                </DialogTitle>
                                ...
                                <div class="flex justify-end gap-x-3">
                                    <u-btn variant="outlined" color="gray" @click="closeModal()"> Close </u-btn>
                                </div>
                            </DialogPanel>
                        </TransitionChild>
                    </div>
